...
export function ExplainDash(){
  ...
  return (
    <div id='features' className="mt-40 flex justify-center items-center relative gap-12 overflow-hidden py-6 bg-linear-to-tr from-sky-100 to-sky-200 dark:from-zinc-900 dark:to-zinc-950 shadow-xl">
