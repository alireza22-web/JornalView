    ...
    <header className="flex flex-col gap-2 items-center justify-center mt-10">
      <div className="flex items-center justify-center flex-col gap-4">
        ...
        <div className="flex gap-3 items-center justify-center mt-3">
          ...
          <Link to={'/'} className="px-6 hover:scale-102 transition-all duration-100 ease-in-out py-2 rounded-xl text-lg border-2 border-sky-600 flex gap-0.5 items-center">
